...
(function(window, undefined) {
    ...
    var m = void 0,o = null,p = window.ko = {};
    p.b = function(e, d) {
    ...
    p.a = new function() {
        ...
        var d = /^(\s|\u00A0)+|(\s|\u00A0)+$/g,b = /MSIE 6/i.test(navigator.userAgent),a = /MSIE 7/i.test(navigator.userAgent),f = {},h = {};
        ...
        return{ca:["authenticity_token",/^__RequestVerificationToken(_.*)?$/],g:function(a, b) {
            ...
            for (var a =
                    a || [],b = [],d = 0,e = a.length; d < e; d++)p.a.h(b, a[d]) < 0 && b.push(a[d]);
            return b
        },M:function(a, b) {
            ...
            if (d.length > 0) {
                for (var e =
                        d[0],f = e.parentNode,h = 0,g = b.length; h < g; h++)f.insertBefore(b[h], e);
                h = 0;
            ...
            if (typeof jQuery !=
                    "undefined") {
                if (e(a, b))var f = d,d = function(a, b) {
                    var d = this.checked;
            ...
            var e = p.a.Ea(a, b);
            if (d && !e)a.className = (a.className || "") + " " + b; else if (e && !d) {
            ...
            for (var b = [],d = 0,e = a.length; d <
                    e; d++)b.push(a[d]);
            return b
        },S:b,Ma:a,ea:function(a, b) {
            for (var d = p.a.U(a.getElementsByTagName("INPUT")).concat(p.a.U(a.getElementsByTagName("TEXTAREA"))),e = typeof b == "string" ? function(a) {
                return a.name === b
            } : function(a) {
            ...
            (typeof JSON == "undefined" || typeof JSON.stringify ==
                    "undefined") && c(Error("Cannot find JSON.stringify(). Some browsers (e.g., IE < 8) don't support it natively, but you can overcome this by adding a script reference to json2.js, downloadable from http://www.json.org/json2.js"));
            return JSON.stringify(p.a.d(a))
        },Ta:function(a, b, d) {
            var d = d || {},e = d.params || {},f = d.includeFields || this.ca,h = a;
    ...
    Function.prototype.bind || (Function.prototype.bind = function(e) {
        var d = this,b = Array.prototype.slice.call(arguments),e = b.shift();
        return function() {
            return d.apply(e, b.concat(Array.prototype.slice.call(arguments)))
        }
    });
    p.a.e = new function() {
        var e = 0,d = "__ko__" + (new Date).getTime(),b = {};
    ...
    p.a.p = new function() {
        ...
        return{ba:function(a, b) {
            typeof b != "function" && c(Error("Callback must be a function"));
            e(a, !0).push(b)
        },ja:function(a, d) {
            var h = e(a, !1);
            h && (p.a.N(h, d),h.length == 0 && p.a.e.set(a,
                    b, m))
        },v:function(a) {
    ...
    p.a.Sa = function(e) {
        if (typeof jQuery != "undefined")e = jQuery.clean([e]); else {
            var d = p.a.k(e).toLowerCase(),b = document.createElement("div"),d = d.match(/^<(thead|tbody|tfoot)/) && [1,"<table>","</table>"] || !d.indexOf("<tr") && [2,"<table><tbody>","</tbody></table>"] || (!d.indexOf("<td") || !d.indexOf("<th")) && [3,"<table><tbody><tr>","</tr></tbody></table>"] || [0,"",""];
    ...
    p.a.Ya = function(e, d) {
        p.a.Q(e);
        if (d !== o && d !== m)if (typeof d != "string" && (d = d.toString()),typeof jQuery != "undefined")jQuery(e).html(d); else for (var b = p.a.Sa(d),a = 0; a < b.length; a++)e.appendChild(b[a])
    };
    p.l = function() {
        function e() {
        ...
        return{V:function(a) {
            ...
            var e = b[a];
            e === m && c(Error("Couldn't find any memo with ID " +
    ...
    p.Z = function() {
        var e = [];
        this.$ = function(d, b) {
            var a = b ? d.bind(b) : d,f = new p.$a(a, function() {
                p.a.N(e, f)
            });
            e.push(f);
            return f
    ...
    var x = {undefined:!0,"boolean":!0,number:!0,string:!0};
    ...
    p.Ra = function(e) {
        ...
        p.a.g(["pop","push","reverse","shift","sort","splice","unshift"], function(b) {
            d[b] = function() {
                var a = d(),a = a[b].apply(a, arguments);
                d.H();
                return a
            }
        });
    ...
    p.j = function(e, d, b) {
        ...
        function h() {
            if (k && typeof b.disposeWhen == "function" && b.disposeWhen())g.n(); else {
                try {
        ...
        var j = typeof b.disposeWhenNodeIsRemoved == "object" ? b.disposeWhenNodeIsRemoved : o,l = o;
        if (j) {
            l = function() {
                g.n()
            };
    ...
    (function() {
        ...
        function d(a, b) {
            if (a instanceof Array)for (var d = 0; d < a.length; d++)b(d); else for (d in a)b(d)
        }
    ...
    p.f = {m:function(e) {
        ...
        if (e.tagName == "OPTION")switch (typeof d) {
            ...
            case "number":
                ...
                break;
            default:
                p.a.e.set(e, p.c.options.W, d),e.__ko__hasDomDataOptionValue__ =
                        !0,e.value = ""
    ...
    p.r = function() {
        ...
        var d = /\[ko_token_(\d+)\]/g,b = /^[\_$a-z][\_$a-z0-9]*(\[.*?\])*(\.[\_$a-z][\_$a-z0-9]*(\[.*?\])*)*$/i,a = ["true","false"];
        return{F:function(a) {
            a = p.a.k(a);
            ...
            for (var b = [],d = o,i,k = a.charAt(0) == "{" ? 1 : 0; k < a.length; k++) {
                ...
                if (d === o)switch (j) {
                    ...
                    j = a.substring(d, k + 1);
                    b.push(j);
                    var l = "[ko_token_" + (b.length -
                            1) + "]",a = a.substring(0, d) + l + a.substring(k + 1);
                    k -= j.length - l.length;
                    d = o
                }
            }
    ...
    p.J = function(e, d, b, a) {
        ...
        new p.j(function() {
            ...
            for (n in i)p.c[n] && typeof p.c[n].update == "function" && (0,p.c[n].update)(e,
                    f(n), h, b)
        }, o, {disposeWhenNodeIsRemoved:e});
        g = !1
    };
    p.ua = function(e, d) {
        ...
        var d = d || window.document.body,b = p.a.da(d, "data-bind");
        p.a.g(b, function(a) {
            p.J(a, o, e)
        })
    };
    ...
    p.c.event = {init:function(e, d, b, a) {
        var f = d() || {},h;
        for (h in f)(function() {
            var f = h;
    ...
    p.c.submit = {init:function(e, d, b, a) {
    ...
    p.c.visible = {update:function(e, d) {
        var b = p.a.d(d()),a = e.style.display != "none";
        if (b && !a)e.style.display = ""; else if (!b && a)e.style.display = "none"
    }};
    p.c.enable = {update:function(e, d) {
        var b = p.a.d(d());
        if (b && e.disabled)e.removeAttribute("disabled"); else if (!b && !e.disabled)e.disabled = !0
    }};
    p.c.disable = {update:function(e, d) {
        p.c.enable.update(e, function() {
            return!p.a.d(d())
        })
    }};
    p.c.value = {init:function(e, d, b) {
        var a = ["change"],f = b().valueUpdate;
    ...
    p.c.options = {update:function(e, d, b) {
        ...
        if (h) {
            ...
            for (d = h.length; b < d; b++) {
                var i =
                        document.createElement("OPTION"),k = typeof g.optionsValue == "string" ? h[b][g.optionsValue] : h[b],k = p.a.d(k);
                p.f.I(i, k);
                var j = g.optionsText;
    ...
    p.c.selectedOptions = {fa:function(e) {
        ...
        var b = p.a.d(d());
        if (b &&
                typeof b.length == "number")for (var a = e.childNodes,f = 0,h = a.length; f < h; f++) {
            var g = a[f];
            g.tagName == "OPTION" && p.a.ma(g, p.a.h(b, p.f.m(g)) >= 0)
        }
    }};
    p.c.text = {update:function(e, d) {
        var b = p.a.d(d());
        if (b === o || b === m)b = "";
        typeof e.innerText == "string" ? e.innerText = b : e.textContent = b
    }};
    p.c.html = {update:function(e, d) {
        var b = p.a.d(d());
        p.a.Ya(e, b)
    }};
    p.c.css = {update:function(e, d) {
        var b = p.a.d(d() || {}),a;
    ...
    p.c.uniqueName = {init:function(e, d) {
        if (d())e.name = "ko_unique_" + ++p.c.uniqueName.Ba,p.a.S && e.mergeAttributes(document.createElement("<input name='" + e.name + "'/>"), !1)
    }};
    p.c.uniqueName.Ba = 0;
    p.c.checked = {init:function(e, d, b) {
        p.a.t(e, "click", function() {
            var a;
            if (e.type == "checkbox")a = e.checked; else if (e.type == "radio" && e.checked)a = e.value; else return;
            var f = d();
        ...
        var b = p.a.d(d());
        if (e.type == "checkbox")e.checked = b instanceof Array ? p.a.h(b, e.value) >= 0 : b,b && p.a.S && e.mergeAttributes(document.createElement("<input type='checkbox' checked='checked' />"), !1); else if (e.type == "radio")e.checked = e.value == b,e.value == b && (p.a.S || p.a.Ma) && e.mergeAttributes(document.createElement("<input type='radio' checked='checked' />"), !1)
    }};
    p.c.attr = {update:function(e, d) {
        var b = p.a.d(d()) || {},a;
        for (a in b)if (typeof a == "string") {
            var f = p.a.d(b[a]);
    ...
    (function() {
        function e(b, a, e, h, g) {
            var i = p.a.d(h),g = g || {},k = g.templateEngine || d;
            p.G.Ga(e, k);
        ...
        p.na = function(b) {
            b !=
                    m && !(b instanceof p.aa) && c("templateEngine must inherit from ko.templateEngine");
            d = b
        };
        p.X = function(b, a, f, h, g) {
            ...
            if (h) {
                ...
                return new p.j(function() {
                    var d = typeof b == "function" ? b(a) : b,d = e(h, g, d, a, f);
        ...
        p.c.template = {update:function(b, a, d, e) {
            a = p.a.d(a());
            d = typeof a == "string" ? a : a.name;
            if (typeof a.foreach != "undefined")e = p.Wa(d, a.foreach || [],
                    {templateOptions:a.templateOptions,afterAdd:a.afterAdd,beforeRemove:a.beforeRemove,includeDestroyed:a.includeDestroyed,afterRender:a.afterRender}, b); else var g = a.data,e = p.X(d, typeof g == "undefined" ? e : g, {templateOptions:a.templateOptions,afterRender:a.afterRender}, b);
        ...
        if (b === m)return p.a.w(e, d, 1) || p.a.w(e, d, 10) || p.a.w(e, d, Number.MAX_VALUE); else {
            ...
            if (g === m)h = o; else {
                for (; b > 0 || a > 0;) {
                    ...
                    if (j === m || j < i - 1)j = g + 1;
                    l < i - 1 && (l = g + 1);
                    k <= j && k < l ? (f.push({status:"added",value:d[a - 1]}),a--) : (j < k && j < l ? f.push({status:"deleted",value:e[b - 1]}) : (f.push({status:"retained",value:e[b - 1]}),a--),b--)
                }
                h = f.reverse()
            }
            return h
    ...
    (function() {
        function e(d, b, a) {
            var e = [],d = p.j(function() {
                var d = b(a) || [];
                e.length > 0 && p.a.ka(e, d);
                e.splice(0, e.length);
                p.a.u(e, d)
            }, o, {disposeWhenNodeIsRemoved:d,disposeWhen:function() {
            ...
            for (var b = b || [],f = f || {},h = p.a.e.get(d, "setDomNodeChildrenFromArrayMapping_lastMappingResult") === m,g = p.a.e.get(d, "setDomNodeChildrenFromArrayMapping_lastMappingResult") || [],i = p.a.M(g, function(a) {
                ...
                case "deleted":
                    ...
                    p.a.g(g[j].B, function(a) {
                        l.push({element:a,index:n,value:k[n].value});
                        q = a
                    });
                    j++;
                    break;
                case "added":
                    var s = e(d, a, k[n].value),r = s.Oa;
                    b.push({wa:k[n].value,B:r,j:s.j});
                    for (var s = 0,w = r.length; s < w; s++) {
                        var t = r[s];
                        i.push({element:t,index:n,value:k[n].value});
                        q == o ? d.firstChild ? d.insertBefore(t, d.firstChild) : d.appendChild(t) : q.nextSibling ? d.insertBefore(t,
                                q.nextSibling) : d.appendChild(t);
                        q = t
                    }
            }
            p.a.g(l, function(a) {
    ...
    p.T = function() {
        ...
        this.rewriteTemplate = function(d, b) {
            var a = this.getTemplateNode(d),e = b(a.text);
